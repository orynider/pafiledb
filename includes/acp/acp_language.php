...
*
* @package acp
* @version $Id: acp_language.php,v 1.3 2008/10/26 08:50:23 orynider Exp $
		...
		switch ($action)
		{
			...
			case 'install':
				...
				$valid_localized = array(
					'icon_back_top', 'icon_contact_aim', 'icon_contact_email', 'icon_contact_icq', 'icon_contact_jabber', 'icon_contact_msnm', 'icon_contact_pm', 'icon_contact_yahoo', 'icon_contact_www', 'icon_post_delete', 'icon_post_edit', 'icon_post_info', 'icon_post_quote', 'icon_post_report', 'icon_user_online', 'icon_user_offline', 'icon_user_profile', 'icon_user_search', 'icon_user_warn', 'button_pm_forward', 'button_pm_new', 'button_pm_reply', 'button_topic_locked', 'button_topic_new', 'button_topic_reply', 'icon_pa_search', 'icon_pa_stats', 'icon_pa_toplist', 'icon_pa_upload', 'icon_pa_viewall', 'icon_pa_moderator', 'icon_pa_download', 'icon_pa_email', 'icon_pa_rate', 'icon_pa_comment_post', 'icon_pa_file_new',
				);
