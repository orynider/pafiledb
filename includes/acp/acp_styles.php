...
*
* @package acp
* @version $Id: acp_styles.php,v 1.3 2008/10/26 08:50:23 orynider Exp $
...
';
		...
		$this->imageset_keys = array(
			...
			'pafiledb'		=> array(
				'icon_pa_search', 'icon_pa_stats', 'icon_pa_toplist', 'icon_pa_upload', 'icon_pa_viewall', 'icon_pa_moderator', 'icon_pa_download', 'icon_pa_email', 'icon_pa_rate', 'icon_pa_comment_post', 'icon_pa_file_new',
			),			
		);
