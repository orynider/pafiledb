...
<!-- BEGIN file_rows -->
  <tr> 
	...
	<a href="{file_rows.FILE_SCREENSHOT}" class="topictitle" target="_blank"><img src="pafiledb/images/lwin.gif" border="0" alt="{L_SCREENSHOTS}"></a>
		<!-- ELSE -->
	<a href="javascript:mpFoto('{file_rows.FILE_SCREENSHOT}')" class="topictitle"><img src="pafiledb/images/lwin.gif" border="0" alt="{L_SCREENSHOTS}"></a>
		<!-- ENDIF -->
	<!-- ELSE -->
	&nbsp;
	<!-- ENDIF -->
