...
This script (pafiledb integration v 0.0.9d + <a href="http://www.mx-system.com/" target="_phpbb" class="copyright">MX Addon 1.03</a>) is modified by  <a href="http://www.hostsector.com/~mohd/" target="_phpbb" class="copyright">Mohd</a><br />
</span></div>