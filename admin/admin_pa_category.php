...
$pafiledb_template->assign_vars( array( 'L_CAT_TITLE' => $l_title,
...
{
	$pafiledb_template->assign_vars( array( 'L_CREATE_CATEGORY' => $lang['Create_category'],
			'L_EDIT' => $lang['Edit'],
...
}elseif ( $mode == 'add' || $mode == 'edit' )
{
	...
	$pafiledb_template->assign_vars( array( 'CAT_NAME' => $cat_name,
			'CAT_DESC' => $cat_desc,
...
}elseif ( $mode == 'delete' )
{
	...
	$pafiledb_template->assign_vars( array( 'S_SELECT_CAT' => $select_cat,
