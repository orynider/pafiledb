...
*
* @package language
* @version $Id: common.php,v 1.2 2008/10/26 08:50:23 orynider Exp $
* @translate $Id: common.php,v 1.2 2008/10/26 08:50:23 orynider Exp $
...
$lang = array_merge($lang, array(
	...
	'ACP_ATTACHMENTS'			=> 'Ataşamente',
	'ACP_ATTACHMENT_SETTINGS'	=> 'Configurări ataşamente',
	'ACP_AUTH_SETTINGS'			=> 'Autentificare',
	'ACP_AUTOMATION'			=> 'Automatizare',
	'ACP_AVATAR_SETTINGS'		=> 'Configurări imagini asociate (avatar)',
	...
	'ACP_MANAGE_PAFILEDB'		=> 'Manage PafileDB',
	'ACP_PAFILEDB_MANAGEMENT'	=> 'PafileDB Admin',
	'ACP_PA_SETTINGS'			=> 'General Settings',
	'ACP_PA_CAT'				=> 'Category Management',
	'ACP_PA_CAT_AUTH'			=> 'Category Permissions',
	'ACP_PA_UG_AUTH'			=> 'UserGroup Permissions',
	...
	'ACP_LOAD_SETTINGS'			=> 'Încarcă configurări',
	'ACP_LOGGING'				=> 'Logare',
	...
	'ACP_ORPHAN_ATTACHMENTS'	=> 'Ataşamente orfane',
	...
	'ACP_VC_SETTINGS'					=> 'Setări confirmare vizuală',
	...
	'SETTING_TOO_SHORT'		=> 'Valoarea specificată pentru variabila “%1$s” nu este suficient de lungă. Lungimea minimă admisă este %2$d.',
...
// Logs
$lang = array_merge($lang, array(
	'ACP_ADMIN_LOGS_EXPLAIN'	=> 'Aici vedeţi listate toate acţiunile efectuate de administratorii forumului. Le puteţi sorta dupa nume de utilizator, după dată, IP sau acţiune. Dacă aveţi permisiunile necesare, puteţi să ştergeţi operaţiunile individuale sau tot log-ul.',
...
// Index page
$lang = array_merge($lang, array(
	'ADMIN_INTRO'				=> 'Mulţumim că aţi ales phpBB ca soluţie pentru forumul dumneavoastră. Această pagină vă va da o scurtă privire de ansamblu a tuturor statisticilor forumului dumneavoastră. Link-urile de pe partea stângă a paginii vă permit să controlaţi orice aspect a experienţei dumneavoastră pe forum. Fiecare pagină va avea instrucţiuni despre modul de folosire a opţiunilor.',
	...
	'RESYNC_POST_MARKING'			=> 'Resincronizează subiectele punctate',
	'RESYNC_POST_MARKING_CONFIRM'	=> 'Sunteţi sigur că doriţi să resincronizaţi subiectele punctate?',
	'RESYNC_POST_MARKING_EXPLAIN'	=> 'Mai întăi deselectaţi toate subiectele şi apoi selectaţi corect subiectele care au avut activitate în ultimele şase luni.',
	'RESYNC_STATS'					=> 'Resincronizează statistici',
	'RESYNC_STATS_CONFIRM'			=> 'Sunteţi sigur că vreţi să resincronizaţi statisticile?',
	'RESYNC_STATS_EXPLAIN'			=> 'Recalculaţi numărul total de mesaje, subiecte, utilizatori şi fişiere.',
	'RUN'							=> 'Porneşte acum',
	...
	'UPLOAD_DIR_SIZE'	=> 'Dimensiunea ataşamentelor trimise',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'Aceasta este o listă cu ultimii 10 utilizatori înregistraţi ce au conturile inactive. Lista întreagă poate fi accesată folosind opţiunea adecvată din meniu sau urmând linkul de mai jos de unde puteţi activa, şterge or aduce aminte (trimiţând un e-mail) acestor utilizatori dacă doriţi.',
...
$lang = array_merge($lang, array(
	...
	'LOG_ATTACHMENTS_DELETED'	=> '<strong>Ataşamente ale utilizatorului eliminate</strong><br />» %s',

	'LOG_ATTACH_EXT_ADD'		=> '<strong>Extensiile ataşamentelor adăugate sau modificate</strong><br />» %s',
	'LOG_ATTACH_EXT_DEL'		=> '<strong>Extensiile ataşamentelor eliminate</strong><br />» %s',
	'LOG_ATTACH_EXT_UPDATE'		=> '<strong>Extensiile ataşamentelor actualizate</strong><br />» %s',
	...
	'LOG_CONFIG_ATTACH'			=> '<strong>Schimbările setărilor ataşamentelor</strong>',
	...
	'LOG_CONFIG_VISUAL'			=> '<strong>Schimbările setărilor de confirmare vizuală</strong>',
	...
	'LOG_TOPIC_DELETED'			=> '<strong>Subiect şters</strong><br />» %s',
	...
	'LOG_DB_BACKUP'			=> '<strong>Backup bază de date</strong>',
	'LOG_DB_DELETE'			=> '<strong>Backup bază de date şters</strong>',
	'LOG_DB_RESTORE'		=> '<strong>Backup bază de date restaurat</strong>',
	...
	'LOG_USERS_APPROVED'	=> '<strong>Utilizatori aprobaţi în grupurile de utilizatori</strong> %1$s<br />» %2$s',
	...
	'LOG_USER_DEL_ATTACH'	=> '<strong>Toate ataşamentele scoase de către utilizatorul</strong><br />» %s',
	...
	'LOG_USER_MOVE_POSTS_USER'	=> '<strong>Toate mesajele mutate în forumul</strong>',
	...
	'LOG_USER_WARNING'			=> '<strong>Avertisment utilizator adăugat</strong><br />» %s',
	...
	'LOG_USER_GROUP_JOIN'			=> '<strong>Utilizatorul a intrat în grup</strong><br />» %s',
	'LOG_USER_GROUP_JOIN_PENDING'	=> '<strong>Utilizatorul a aderat la grup şi trebuie să fie aprobat</strong><br />» %s',
