<?php
/**
 * Language file [info_acp_pafiledb.php]
 * 
* @package phpBB Extension - Download Manager
 * @author admin
 * @version d: info_acp_pafiledb.php,v 0.9.0 2018/06/05 00:08:08  orynider Exp $
...
$lang = array_merge( $lang, array( // #
	...
	// adminCP index
	//
	'ACP_PA_FILES'					=> 'PafileDB Admin',
	'ACP_MANAGE_CATEGORIES'			=> 'Manage Categories',
	'ACP_MANAGE_CONFIG'				=> 'Configuration',
	'ACP_MANAGE_DOWNLOADS'			=> 'Manage Downloads',

	'pafileDB_Download'				=> 'Download Database',
	'0_Configuration'				=> 'General Settings',
	'1_Cat_manage'					=> 'Category Management',
	'2_File_manage'					=> 'File Management',
	'3_Permissions'					=> 'Permissions',
	'4_License'						=> 'License',
	'5_Custom_manage'				=> 'Custom fields',
	'6_Fchecker'					=> 'File checker',
	...
	'ParType_pa_mapping_info'		=> 'pafileDB category mapping',
	
	'ParType_pa_quick_cat'			=> 'pafileDB default category',
	'ParType_pa_quick_cat_info'		=> 'pafileDB default category',
	...
	'Enable_module_explain'			=> 'When disabled for users, admin is still allowed access.',
	...
	'Sort_order_explain'			=> 'ASC or DESC sorting',
	'Topnum'						=> 'Top Number',
	...
	'Format_truncate_links_explain'	=> 'Links are shortened, eg t ex \'mxpcms.sf.net...\'',
	...
	'File_saftey'					=> '{html_path}</FONT> then the files will be skipped for security reasons.<br /><br />Please make sure that <FONT COLOR="#FF0000">{html_path}</FONT> is the path that you use for your files.<br /><br />.">ith <FONT COLOR="#FF0000">{html_path}</FONT> then the files will be skipped for security reasons.<br /><br />Please make sure that <FONT COLOR="#FF0000">{html_path}</FONT> is the path that you use for your files.<br /><br />.',
	...
	'Fieldexplain'					=> 'm field and then you can add the file size on the Add/Edit file page.',
