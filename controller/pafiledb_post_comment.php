...
* @version $Id: pa_post_comment.php,v 1.30 2008/12/08 23:58:04 orynider Exp $
 ...
 *
 */
class pafiledb_post_comment extends \orynider\pafiledb\core\pafiledb_public
{
	...
	var $html_entities_match;
	
	var $html_entities_replace; 
	
	var $unhtml_specialchars_match; 
	
	var $unhtml_specialchars_replace;
	...
	*/
	...
	function main( $action  = false )
	{
		...
		if ( $preview )
		{
			...
			//$template->set_filenames( array( 'preview' => 'pa_post_preview.tpl' ) );
