ALTER TABLE phpbb_pa_download_info 
CHANGE downloader_borwser downloader_browser VARCHAR(255) NOT NULL;

ALTER TABLE phpbb_pa_votes 
CHANGE voter_borwser voter_browser VARCHAR(255) NOT NULL;
