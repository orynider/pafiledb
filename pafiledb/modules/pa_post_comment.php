 ...
 * 
 *    $Id: pa_post_comment.php,v 1.1 2005/01/09 22:15:23 jonohlsson Exp $
 */
...
class pafiledb_post_comment extends pafiledb_public
{
	function main( $action )
	{
		...
		{ 
			...
			$pafiledb_template->assign_vars( array( 'HTML_STATUS' => $html_status,
			...
			if ( $preview )
			{
				...
				$pafiledb_template->assign_vars( array( 'PREVIEW' => true,
