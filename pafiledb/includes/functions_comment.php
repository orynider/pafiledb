 ...
 *    email                : mohd@mohd.tk
 * 
 *    $Id: functions_comment.php,v 1.1 2005/01/09 22:15:22 jonohlsson Exp $
 */
...
function display_comments( &$file_data )
{
	...
	$pafiledb_template->assign_vars( array( 'L_COMMENTS' => $lang['Comments'] ) 
		);
	...
	{
		$pafiledb_template->assign_vars( array( 'L_NO_COMMENTS' => $lang['No_comments'],
				'NO_COMMENTS' => true ) 
			);
	}
	...
	while ( $comments_row = $db->sql_fetchrow( $result ) )
	{
		...
		$pafiledb_template->assign_block_vars( 'text', array( 'POSTER' => $poster,
	...
	$pafiledb_template->assign_vars( array( 'REPLY_IMG' => ( $pafiledb->modules[$pafiledb->module_name]->auth[$file_data['file_catid']]['auth_post_comment'] ) ? $images['pa_comment_post'] : '',
